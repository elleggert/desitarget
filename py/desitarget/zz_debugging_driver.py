...
def format_output(result):
    cols = [('RELEASE', '>i2'), ('BRICKID', '>i4'), ('BRICKNAME', 'S8'), ('BRICK_OBJID', '>i4'), ('MORPHTYPE', 'S4'),
            ...
            ('PHOTSYS', '<U1'), ('TARGETID', '>i8'), ('DESI_TARGET', '>i8'), ('BGS_TARGET', '>i8'),
            ('MWS_TARGET', '>i8'),
            ('SUBPRIORITY', '>f8'), ('OBSCONDITIONS', '>i8'), ('PRIORITY_INIT_DARK', '>i8'),
            ('NUMOBS_INIT_DARK', '>i8'),
...
print("No of LRG       :", len(df[df['LRG'] == True]))
print("No of ELG       :", len(df[df['ELG'] == True]))
print("No of QSO       :", len(df[df['QSO'] == True]))
print("No of G Dropouts:", len(df[df['GLBG'] == True]))
print("No of R Dropouts:", len(df[df['RLBG'] == True]))